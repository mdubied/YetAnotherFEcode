function h = PlotFieldonDeformedMeshSpecificColor(Nodes,Elements,disp,color,varargin)
%--------------------------------------------------------------------------
% Purpose:
...
if dimension == 3   % For 3D plots   
    ...
    view(0.503287490371036,6.638918592241602)   
        camproj('orthographic')
        campos([0.067861784447437,-4.284350926420441,0.488915862450777])
        camtarget([0.031067637361973,-0.092720869545619,0.001041676113367])
        camup([0,0,1])
        camva(4.619843356851527);
        
    hold on;
    h = patch(defoX,defoY,defoZ,color,'EdgeColor',meshcolor,...
