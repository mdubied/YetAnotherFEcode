function [ r, drdqdd,drdqd,drdq, c0] = residual_reduced_nonlinear_hyper_defected( q, qd, qdd, t, Assembly, Fext)
...
u = V*q;
Ud=Assembly.DATA.Ud;
[K_V, F_V] = Assembly.tangent_stiffness_and_force_defected_hyper(u,Ud);
%% 
