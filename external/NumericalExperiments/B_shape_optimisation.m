...
h = 0.01;
tmax = 2.0;
kActu = 0.1;    % tested with 3.0 for 660el, 1.3 for 1272el, 0.25 for 4270el, 0.1 for 8086, 0.03 or 24822
...
[xiStar_1,xiEvo_1,LEvo_1, LwoBEvo_1, nIt_1] = optimise_shape_3D(myElementConstructor,nsetBC, ...
    ...
    'gStepSize',0.0005, ...  % 0.0005 for 8086, 0.002 below, 0.0001 for 24822
    'nRebuild',6, ...
...
b = [0.4;0.4;
    ...
    0.4;0.4;
    0.3;0.3;
    0.5;0.5;    % set to 0.4 for 24822 elements, 0.5 else
    0.3;0.3;
    0.3;0.3;
