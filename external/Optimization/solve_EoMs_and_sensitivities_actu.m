...
function TI_NL_PROM = solve_EoMs_and_sensitivities_actu(V,PROM_Assembly,fIntTensors,tailProperties,spineProperties,dragProperties,actuTop,actuBottom,h,tmax,p)
    ...
    actuSignalT = @(t) actuation_signal_5(k,t,p);    
    actuSignalB = @(t) -actuation_signal_5(k,t,p);
    
    fActu = @(t,q) actuation_force_5(k,t,q,B1T,B2T, B1B,B2B,p);
    ...
    pd_actu = @(t,q,p)derivatives_actuation_force_5(k,t,q,B1T,B2T, B1B,B2B,p);
