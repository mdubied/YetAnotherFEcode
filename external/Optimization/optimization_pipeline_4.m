...
%
% Synthax:
% [xiStar,LrEvo] = optimization_pipeline_4(myElementConstructor,nset,nodes,elements,U,d,h,tmax,A,b,varargin)
%
...
function [xiStar,xiEvo,LrEvo] = optimization_pipeline_4(myElementConstructor,nset,nodes,elements,U,d,h,tmax,A,b,varargin)
    ...
    for k = 1:maxIteration
        ...
        rho = 1;
        tensors_hydro_FOM = unreduced_tensors_hydro_PFOM(svAssembly, elements, U, skinElements, skinElementFaces, vwater, rho);
