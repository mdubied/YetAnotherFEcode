% ------------------------------------------------------------------------ 
% Accuracy benchmarking: computational cost of the ROM model (Ssv).
...
%%
% ROM-sv
tensors_hydro_ROMsv = reduced_tensors_hydro_ROM(svAssembly, elements, Vsv, skinElements, skinElementFaces, vwater, rho, c);
