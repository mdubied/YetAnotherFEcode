function T = Tu2_conf1(rho,vw1,vw2,inv,x01,x02,x03,x04,x05,x06)
...
.^2)).^(-1/2))+(-1/48).*inv.*(4.*vw1.^2+4.*vw2.^2).*(pi.^2+(-4).* ...
...
x02+(-1).*x04)+(1/6).*inv.*(4.*vw1.^2+4.*vw2.^2).*(x01+(-1).*x03) ...
.*(1+(-1).*inv.^2.*(4.*vw1.^2+4.*vw2.^2).^(-1).*(2.*vw2.*(x01+(-1) ...
.*x03)+(-2).*vw1.*(x02+(-1).*x04)).^2.*((x01+(-1).*x03).^2+(x02+( ...
-1).*x04).^2).^(-1)).^(-1/2).*(2.*inv.*vw1.*((4.*vw1.^2+4.*vw2.^2) ...
.*((x01+(-1).*x03).^2+(x02+(-1).*x04).^2)).^(-1/2)+inv.*(4.* ...
vw1.^2+4.*vw2.^2).*(2.*vw2.*(x01+(-1).*x03)+(-2).*vw1.*(x02+(-1).* ...
x04)).*((4.*vw1.^2+4.*vw2.^2).*((x01+(-1).*x03).^2+(x02+(-1).*x04) ...
.^2)).^(-3/2).*(x02+(-1).*x04)).*acos(inv.*(2.*vw2.*(x01+(-1).* ...
x03)+(-2).*vw1.*(x02+(-1).*x04)).*((4.*vw1.^2+4.*vw2.^2).*((x01+( ...
-1).*x03).^2+(x02+(-1).*x04).^2)).^(-1/2))),0,0];
