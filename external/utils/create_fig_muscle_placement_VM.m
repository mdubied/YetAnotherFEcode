...
% ------------------------------------------------------------------------
function fig = create_fig_muscle_placement_VM(Mesh, nodes, elements, propRigid, esetBC)
    ...
    text('Rotation',90,'String','deformation',...
        'Position',[0.0740022935224962 -0.121460165568961 -0.125607558196756],...
        'Visible','on');
    ...
    % Create textarrow
    annotation(fig,'textarrow',[0.350663580246914 0.302619149103396],...
    [0.254475308641975 0.39901650496004],'String',{'rigid'},'LineWidth',1,...
    'Interpreter','latex',...
    ...
    % Create textarrow
    annotation(fig,'textarrow',[0.198773148148148 0.138996913580247],...
