...
% Plot mesh
figure(1); PlotMesh(nodes,elements,1);
...
%plot(Nodes(fixed_nodes,1),Nodes(fixed_nodes,2),'r*')  %for 2D
hold on
...
myMesh.set_essential_boundary_condition((fixed_nodes),1:3,0);
...
nf = find_node(1/2,0.1/2,0.1/2,nodes); % node where to put the force
%nf=363;
